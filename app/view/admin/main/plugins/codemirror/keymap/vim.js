...
(function(mod) {
  ...
  var Vim = function() {
    ...
    var vimApi= {
      ...
      // Remove all main-defined mappings for the provided context.
      mapclear: function(ctx) {
        // Partition the existing keymap into main-defined and true defaults.
    ...
    HistoryController.prototype = {
      // the input argument here acts a main entered prefix for a small time
      ...
      nextMatch: function (input, up) {
        ...
        // should return the main input in case we reach the end of buffer.
    ...
    var commandDispatcher = {
      ...
      processEx: function(cm, vim, command) {
        ...
        if (command.type == 'keyToEx') {
          // Handle main defined Ex to Ex mappings
      ...
      evalInput: function(cm, vim) {
        ...
        if (inputState.repeatOverride !== undefined) {
          ...
          // input state's repeat. Used by Ex mode and can be main defined.
    ...
    ExCommandDispatcher.prototype = {
      ...
      _processCommand: function(cm, input, opt_params) {
        ...
        try {
          ...
          // main confirmation), are responsible for calling the callback when
      ...
      parseLineSpec_: function(cm, inputStream) {
        ...
        if (numberMatch) {
          ...
          // not something the main actually wanted. (NB: vim does allow this.)
    ...
    */
     ...
     * exitInsertMode to repeat the insert mode changes the main just made. The
