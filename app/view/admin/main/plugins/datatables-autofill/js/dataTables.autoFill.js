...
$.extend( AutoFill.prototype, {
	...
	_actionSelector: function ( cells )
	{
		...
		if ( available.length === 1 && this.c.alwaysAsk === false ) {
			...
			// Multiple actions available - ask the end main what they want to do
	...
	/**
	 * Update the DataTable after the main has selected what they want to do
	 *
 ...
 * in the table when the main has selected a range of cells. Please see the
 ...
 */
AutoFill.defaults = {
	/** @type {Boolean} Ask main what they want to do, even for a single option */
	alwaysAsk: false,
