...
var defaultOptions = {
   ...
   * This can be useful if you need some additional main input before sending
  ...
  /**
   * If this is not null, then the main will be prompted before removing a file.
   */
  ...
  /*
   ...
   the main interface specific stuff. Overwriting them won't break the upload
...
var Dropzone = /*#__PURE__*/function (_Emitter) {
  ...
  dropzone_createClass(Dropzone, [{
    ...
    } // Can be called by the main to remove a file
    ...
    value: function _uploadData(files, dataBlocks) {
      ...
      } // Let the main add additional data if necessary
...
Dropzone.getElements = function (els, name) {
  ...
  return elements;
}; // Asks the main the question and calls accepted or rejected accordingly
//
