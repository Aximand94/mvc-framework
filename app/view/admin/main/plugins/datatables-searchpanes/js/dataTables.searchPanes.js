...
(function () {
    ...
    var SearchPane = /** @class */ (function () {
        ...
        SearchPane.prototype._setListeners = function () {
            ...
            this.s.dtPane.on('main-select.dtsp', function (e, _dt, type, cell, originalEvent) {
         ...
         * @param display the value to be displayed to the main
                ...
                columnDefs: [
                    {
                        ...
                        // This is null if not defined by the main, meaning that automatic type detection would take place
         ...
         * @returns {object} The options for the row extended to include the options from the main.
         */
