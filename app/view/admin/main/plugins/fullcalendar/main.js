...
var FullCalendar = (function (exports) {
    ...
    */
    function parseEventDef(refined, extra, sourceId, allDay, hasEnd, context) {
        ...
        // help out EventApi from having main modify props
    ...
    var EventApi = /** @class */ (function () {
        ...
        */
        ...
        Object.defineProperty(EventApi.prototype, "classNames", {
            // NOTE: main can't modify these because Object.freeze was called in event-def parsing
    ...
    */
    ...
    /*
    Detects when the main clicks on an event within a DateComponent
    */
    ...
    /*
    Triggers events and adds/removes core classNames when the main's pointer
    ...
    */
    var PointerDragging = /** @class */ (function () {
        ...
        // can be called by main of this class, to cancel touch-based scrolling for the current drag
    ...
    var AutoScroller = /** @class */ (function () {
        ...
        AutoScroller.prototype.buildCaches = function () {
            return this.queryScrollEls().map(function (el) {
                if (el === window) {
                    return new WindowScrollGeomCache(false); // false = don't listen to main-generated scrolls
                }
                return new ElementScrollGeomCache(el, false); // false = don't listen to main-generated scrolls
            });
        };
    ...
    */
    var FeaturefulElementDragging = /** @class */ (function (_super) {
        ...
        function FeaturefulElementDragging(containerEl, selector) {
            ...
            _this.isInteracting = false; // is the main validly moving the pointer? lasts until pointerup
    ...
    */
    ...
    /*
    Monitors when the main clicks on a specific date/time of a component.
    ...
    */
    ...
    /*
    Tracks when the main selects a portion of time of a component,
    ...
    var DateSelecting = /** @class */ (function (_super) {
        ...
        function DateSelecting(settings) {
            ...
            _this.handlePointerDown = function (ev) {
                ...
                // if touch, require main to hold down
