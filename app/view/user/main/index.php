                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-secondary" href="/user/post/edit/?id=<?=$post['id']?>">Edit</a>
                                <a class="btn btn-danger" href="/user/post/delete/?id=<?=$post['id']?>">Delete</a>
                                <a class="btn btn-primary" href="/main/single/?id=<?=$post['id']?>">Show</a>
                            </td>
                        </tr>
                        <?php endforeach;?>
                        </tbody>
